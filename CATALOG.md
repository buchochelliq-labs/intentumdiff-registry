...
> Org-built and scanned; checksums verified on install.

### intentdiff-abap-parser
...
### intentdiff-assemblyscript-parser
...
> Listed but unverified (custom source or no checksums). Install only if you trust the source.
